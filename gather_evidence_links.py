...
if __name__ == "__main__":
    ...
    gemini_flash_api = GeminiAPI(model_name="gemini-1.5-flash-latest", secrets_file="./secrets/gemini_keys.json", response_mime_type="application/json", response_schema=response_schema_questions)
